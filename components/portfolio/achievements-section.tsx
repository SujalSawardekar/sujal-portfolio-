...
export function AchievementsSection() {
  ...
  return (
    <section 
      id="achievements" 
      ref={sectionRef}
      className={`mx-6 my-12 rounded-[2.5rem] bg-[#09090b] py-24 px-8 border border-white/5 transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`}
    >
