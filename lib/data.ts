...
export const projects = [
    // UI/UX Projects
    {
        ...
        problem: "The existing website lacked clarity and visual hierarchy, making it hard to find important information. It failed to communicate the technical aspects of the industrial products effectively, reducing readability and user trust.",
        solution: "Restructured the information architecture and simplified the layout to prioritize content. Established a clear visual system with consistent typography, spacing, and a professional color palette to convey trust and clarity.",
        tools: ["Figma", "Information Architecture", "UI System", "Prototyping"],
        outcome: "Delivered a clean, professional interface with a strong visual hierarchy. The redesign improved readability, component scalability, and significantly enhanced the brand's ability to communicate confidently.",
    ...
    },
    {
        ...
        title: "CrickAnalyzer",
        category: "App Design",
        problem: "Displaying heavy statistical data is always tricky. Previously, the app's interface was cluttered, making it hectic and overwhelming for users to navigate. The platform desperately needed optimization for mobile usability and better readability on smaller screens.",
        solution: "Revamped the experience by designing a clean, modern, and trending UI. By completely restructuring the Information Architecture (IA) and updating the typography, the app is perfectly tailored for mobile devices. Complex data—like wagon wheels, ball-by-ball reports, and player analytics—is easily digestible at a glance.",
        tools: ["Figma", "UI Design", "Data Visualization", "Information Architecture", "Prototyping"],
        outcome: "Delivered a seamless user experience tailored for mobile devices, successfully turning complex data into a highly digestible and clean format.",
    ...
    },
    {
        ...
        problem: "Farmers often face preventable crop losses due to a lack of timely, contextual guidance. Digital literacy gaps make traditional, text-heavy agricultural apps difficult to adopt in rural environments.",
        solution: "Designed an intuitive, end-to-end companion covering the entire crop cycle. The UI focuses on high readability, visual cues, and multilingual voice commands to overcome digital barriers, featuring AI Disease Diagnosis, Stage-Wise Guidance, and Financial Tracking.",
        tools: ["Figma", "UX Research", "UI Design", "Agri-tech", "Accessibility"],
        outcome: "Strengthened the digital agriculture ecosystem by translating complex Agri-tech data into an accessible, user-friendly experience, helping reduce crop losses and directly contributing to UNSDG 2 (Zero Hunger).",
